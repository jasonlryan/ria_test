  ...
  records.forEach((record) => {
    ...
    Object.keys(record).forEach((key) => {
      if (key.startsWith("region_")) {
        ...
        const relationshipStatusGroup = key.replace("relationship_status_", "");
        groupedData.relationship_status[relationshipStatusGroup] = record[key];
